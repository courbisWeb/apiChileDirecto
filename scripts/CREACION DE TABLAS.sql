...
, 	ID_PROVINCIA		INT
, 	ID_COMUNA			INT
, 	CONSTRAINT	FK_COMUNA_PERSONA 			FOREIGN KEY(ID_COMUNA) 					REFERENCES COMUNA(ID)
, 	CONSTRAINT	FK_PROVINCIA_PERSONA 		FOREIGN KEY(ID_PROVINCIA) 				REFERENCES PROVINCIA(ID)
, 	CONSTRAINT	FK_REGION_PERSONA 			FOREIGN KEY(ID_REGION) 					REFERENCES REGION(ID)
